...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone V" DIRECTION="ADD" OPTIMIZE="SPEED" PIPELINE=14 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=11 WIDTH_MAN=52 clk_en clock dataa datab result
//VERSION_BEGIN 18.1 cbx_altbarrel_shift 2019:04:11:16:03:27:SJ cbx_altfp_add_sub 2019:04:11:16:03:27:SJ cbx_altpriority_encoder 2019:04:11:16:03:27:SJ cbx_cycloneii 2019:04:11:16:03:28:SJ cbx_lpm_add_sub 2019:04:11:16:03:28:SJ cbx_lpm_compare 2019:04:11:16:03:28:SJ cbx_mgl 2019:04:11:18:00:57:SJ cbx_nadder 2019:04:11:16:03:28:SJ cbx_stratix 2019:04:11:16:03:28:SJ cbx_stratixii 2019:04:11:16:03:28:SJ  VERSION_END
...
//VERSION_BEGIN 18.1 cbx_altbarrel_shift 2019:04:11:16:03:27:SJ cbx_mgl 2019:04:11:18:00:57:SJ  VERSION_END

//synthesis_resources = reg 56 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_adder64_14_altbarrel_shift_otd
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //altfp_adder64_14_altbarrel_shift_otd


//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" PIPELINE=1 REGISTER_OUTPUT="NO" SHIFTDIR="RIGHT" WIDTH=55 WIDTHDIST=6 aclr clk_en clock data distance result
//VERSION_BEGIN 18.1 cbx_altbarrel_shift 2019:04:11:16:03:27:SJ cbx_mgl 2019:04:11:18:00:57:SJ  VERSION_END
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_adder64_14_altbarrel_shift_u0g
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	assign
		...
		smux_w = {((({55{(sel_w[5] & (~ dir_w[5]))}} & {sbit_w[297:275], pad_w[31:0]}) | ({55{(sel_w[5] & dir_w[5])}} & {pad_w[31:0], sbit_w[329:307]})) | ({55{(~ sel_w[5])}} & sbit_w[329:275])), ((({55{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[258:220], pad_w[15:0]}) | ({55{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[274:236]})) | ({55{(~ sel_w[4])}} & sbit_w[274:220])), ((({55{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[211:165], pad_w[7:0]}) | ({55{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[219:173]})) | ({55{(~ sel_w[3])}} & sbit_w[219:165])), ((({55{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[160:110], pad_w[3:0]}) | ({55{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[164:114]})) | ({55{(~ sel_w[2])}} & sbit_w[164:110])), ((({55{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[107:55], pad_w[1:0]}) | ({55{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[109:57]})) | ({55{(~ sel_w[1])}} & sbit_w[109:55])), ((({55{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[53:0], pad_w[0]}) | ({55{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[54:1]})) | ({55{(~ sel_w[0])}} & sbit_w[54:0]))};
endmodule //altfp_adder64_14_altbarrel_shift_u0g


//altpriority_encoder CBX_AUTO_BLACKBOX="ALL" PIPELINE=1 WIDTH=64 WIDTHAD=6 aclr clk_en clock data q
//VERSION_BEGIN 18.1 cbx_altpriority_encoder 2019:04:11:16:03:27:SJ cbx_mgl 2019:04:11:18:00:57:SJ  VERSION_END
...
//synthesis_resources = lpm_add_sub 14 lpm_compare 1 reg 1410 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_adder64_14_altfp_add_sub_tkj
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	altfp_adder64_14_altbarrel_shift_otd   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	altfp_adder64_14_altbarrel_shift_u0g   rbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //altfp_adder64_14_altfp_add_sub_tkj
//VALID FILE
...
module altfp_adder64_14 (
	...
	altfp_adder64_14_altfp_add_sub_tkj	altfp_adder64_14_altfp_add_sub_tkj_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_adder64_14.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_adder64_14.inc TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_adder64_14.cmp TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_adder64_14.bsf TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_adder64_14_inst.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_adder64_14_bb.v TRUE
