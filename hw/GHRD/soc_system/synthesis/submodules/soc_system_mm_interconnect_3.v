...
module soc_system_mm_interconnect_3 (
	...
	wire  [13:0] pio_controle_s1_agent_m0_address;                                  // pio_controle_s1_agent:m0_address -> pio_controle_s1_translator:uav_address
	...
	wire  [84:0] pio_controle_s1_agent_rf_source_data;                              // pio_controle_s1_agent:rf_source_data -> pio_controle_s1_agent_rsp_fifo:in_data
	...
	wire  [84:0] pio_controle_s1_agent_rsp_fifo_out_data;                           // pio_controle_s1_agent_rsp_fifo:out_data -> pio_controle_s1_agent:rf_sink_data
	...
	wire         cmd_mux_src_valid;                                                 // cmd_mux:src_valid -> pio_controle_s1_agent:cp_valid
	wire  [83:0] cmd_mux_src_data;                                                  // cmd_mux:src_data -> pio_controle_s1_agent:cp_data
	wire         cmd_mux_src_ready;                                                 // pio_controle_s1_agent:cp_ready -> cmd_mux:src_ready
	wire   [1:0] cmd_mux_src_channel;                                               // cmd_mux:src_channel -> pio_controle_s1_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                         // cmd_mux:src_startofpacket -> pio_controle_s1_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                           // cmd_mux:src_endofpacket -> pio_controle_s1_agent:cp_endofpacket
	...
	wire  [84:0] onchip_memory2_0_s1_agent_rf_source_data;                          // onchip_memory2_0_s1_agent:rf_source_data -> onchip_memory2_0_s1_agent_rsp_fifo:in_data
	...
	wire  [84:0] onchip_memory2_0_s1_agent_rsp_fifo_out_data;                       // onchip_memory2_0_s1_agent_rsp_fifo:out_data -> onchip_memory2_0_s1_agent:rf_sink_data
	...
	wire  [83:0] cmd_mux_001_src_data;                                              // cmd_mux_001:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [83:0] mm_bridge_1_m0_agent_cp_data;                                      // mm_bridge_1_m0_agent:cp_data -> router:sink_data
	...
	wire         pio_controle_s1_agent_rp_valid;                                    // pio_controle_s1_agent:rp_valid -> router_001:sink_valid
	wire  [83:0] pio_controle_s1_agent_rp_data;                                     // pio_controle_s1_agent:rp_data -> router_001:sink_data
	wire         pio_controle_s1_agent_rp_ready;                                    // router_001:sink_ready -> pio_controle_s1_agent:rp_ready
	wire         pio_controle_s1_agent_rp_startofpacket;                            // pio_controle_s1_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire         pio_controle_s1_agent_rp_endofpacket;                              // pio_controle_s1_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire  [83:0] onchip_memory2_0_s1_agent_rp_data;                                 // onchip_memory2_0_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [83:0] router_src_data;                                                   // router:src_data -> mm_bridge_1_m0_limiter:cmd_sink_data
	wire         router_src_ready;                                                  // mm_bridge_1_m0_limiter:cmd_sink_ready -> router:src_ready
	wire   [1:0] router_src_channel;                                                // router:src_channel -> mm_bridge_1_m0_limiter:cmd_sink_channel
	...
	wire  [83:0] mm_bridge_1_m0_limiter_cmd_src_data;                               // mm_bridge_1_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	wire         mm_bridge_1_m0_limiter_cmd_src_ready;                              // cmd_demux:sink_ready -> mm_bridge_1_m0_limiter:cmd_src_ready
	wire   [1:0] mm_bridge_1_m0_limiter_cmd_src_channel;                            // mm_bridge_1_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [83:0] rsp_mux_src_data;                                                  // rsp_mux:src_data -> mm_bridge_1_m0_limiter:rsp_sink_data
	wire         rsp_mux_src_ready;                                                 // mm_bridge_1_m0_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire   [1:0] rsp_mux_src_channel;                                               // rsp_mux:src_channel -> mm_bridge_1_m0_limiter:rsp_sink_channel
	...
	wire  [83:0] mm_bridge_1_m0_limiter_rsp_src_data;                               // mm_bridge_1_m0_limiter:rsp_src_data -> mm_bridge_1_m0_agent:rp_data
	wire         mm_bridge_1_m0_limiter_rsp_src_ready;                              // mm_bridge_1_m0_agent:rp_ready -> mm_bridge_1_m0_limiter:rsp_src_ready
	wire   [1:0] mm_bridge_1_m0_limiter_rsp_src_channel;                            // mm_bridge_1_m0_limiter:rsp_src_channel -> mm_bridge_1_m0_agent:rp_channel
	...
	wire   [1:0] mm_bridge_1_m0_limiter_cmd_valid_data;                             // mm_bridge_1_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire         pio_controle_s1_agent_rdata_fifo_src_valid;                        // pio_controle_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] pio_controle_s1_agent_rdata_fifo_src_data;                         // pio_controle_s1_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         pio_controle_s1_agent_rdata_fifo_src_ready;                        // avalon_st_adapter:in_0_ready -> pio_controle_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                     // avalon_st_adapter:out_0_valid -> pio_controle_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                      // avalon_st_adapter:out_0_data -> pio_controle_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                     // pio_controle_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                     // avalon_st_adapter:out_0_error -> pio_controle_s1_agent:rdata_fifo_sink_error
